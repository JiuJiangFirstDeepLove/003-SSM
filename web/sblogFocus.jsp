...
<jsp:include page="top.jsp">
	<jsp:param name="menu" value="focus"/>
</jsp:include>
<div id="picnews2"></div>
<div id="middle" style="padding:10px;">
	<form name="info" id="info" action="page_listSblogsFocus.action" method="post" style="width:100%;height:100%">
	<input type="hidden" name="pageNo" id="pageNo" value="${paperUtil.pageNo}"/>
	<div id="list" style="width:90%">
		 <div class="nav">
		    <div class="nav1" style="width:200px!important;">当前位置: 主页 > 关注帖子 </div>
...
{
   var num = /^\d+(\.\d+)?$/;
   document.info.action="page_listSblogsFocus.action";
